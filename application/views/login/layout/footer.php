...
<footer class="sticky-footer ">
    <div class="container">
        <div class="copyright text-center">
            <span>Copyright &copy; GennextIt Pvt. Ltd. 2019</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<!-- <script src="<?php echo base_url('assets/ajax/admin.js') ?>"> </script> -->
<script src="<?php echo base_url('assets/ajax/common.js') ?>"> </script>
